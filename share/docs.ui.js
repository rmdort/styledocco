...
(function() {
  ...
  var stylenav = bodyEl.getElementsByClassName('stylenav')[0];
  stylenav.appendChild(tocList);

  var csstoggle = bodyEl.getElementsByClassName('csstoggle')[0],
      codes = bodyEl.getElementsByClassName('code');



  $(document).ready(function(){

    var csstoggle = $('.csstoggle');

    csstoggle.click(function(e){

      var $this = $(this);

      if($this.hasClass("active")){

        $this.removeClass("active").text('Show CSS');
        $('.code').stop().animate({
          right:"35%"
        },500);
        ...
        $this.addClass("active").text('Hide CSS');
